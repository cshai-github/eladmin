...
public class RedisUtil {
    ...
    public List<Object> multiGet(List<String> keys) {
        ...
        Optional.ofNullable(list).ifPresent
                (e -> list.forEach(o -> Optional.ofNullable(o).ifPresent(resultList::add)));
        return resultList;
    }
    ...
    /**
     * @describe 获取字典中键为key的值
     * @param dictionary 字典
     * @param key 字典中键为key
     * @return java.lang.Object
     */
    public Object hget(String dictionary, String key) {
        return redisTemplate.opsForHash().get(dictionary, key);
    }

    /**
     * @describe 取hashKey对应的所有键值
     * @param key 键
    ...
    /**
     * @describe 向一张hash表中放入一个数据, 如果不存在将创建
     * @param key 键
     * @param item 项
     * @param value 值
    ...
    /**
     * @describe 向一张hash表中放入数据, 如果不存在将创建, 并设置过期时间
     * @param key 键
     * @param item 项
     * @param value 值
    ...
    /**
     * @describe hash递增 如果不存在,就会创建一个并把新增后的值返回
     * @param key 键
     * @param item 项
     * @param by 要增加几(大于0)
     * @return double
    ...
    /**
     * @describe 删除list缓存中prefix+id的元素
     * @param prefix 前缀
	 * @param ids id
     * @return void
     */

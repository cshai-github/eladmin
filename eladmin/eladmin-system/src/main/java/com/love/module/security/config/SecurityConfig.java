...
import com.love.annotation.AnonymousAccess;
import com.love.module.security.config.bean.SecurityProperties;
import com.love.module.security.security.JwtAccessDeniedHandler;
import com.love.module.security.security.JwtAuthenticationEntryPoint;
import com.love.module.security.security.TokenConfigurer;
...
import com.love.utils.enums.RequestMethodEnum;
 ...
 * @Description  @EnableGlobalMethodSecurity注解,开启spring方法级安全时，只需要在任何 @Configuration实例上使用。
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET,
                        "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/webSocket/**").permitAll()
                //swagger 文档
